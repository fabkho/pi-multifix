...
* rename to pi-multirepo, add postMergeHooks, preMRHooks, state widget, generalize task language
...
* rename to pi-multirepo, add postMergeHooks, preMRHooks, state widget, generalize task language ([aff2234](https://github.com/fabkho/pi-multifix/commit/aff2234b3a3f31cfa3f499ef4a1c57db73bc28be))
* state widget, pre-commit checks, generalize bug→task language ([497e8da](https://github.com/fabkho/pi-multifix/commit/497e8da501c79799fa8efc11248d712d459a4e70))
...
* review findings — conditional status, shell hooks via /bin/sh, hook validation, legacy config fallback ([189c5ce](https://github.com/fabkho/pi-multifix/commit/189c5ce6f05677a7d83a31d1eef34c491bcca2b8))
